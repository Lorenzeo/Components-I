...
function articleMaker(dataObj){
  ...
  articlePara1.textContent = dataObj.firstParagraph;
  articlePara2.textContent = dataObj.secondParagraph;
  articlePara3.textContent = dataObj.thirdParagraph;
